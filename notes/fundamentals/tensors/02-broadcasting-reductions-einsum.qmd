...
<!-- "Broadcasting is free" is true of the metadata and false of the expression — a distinction that becomes a 16 GiB problem later in this post.
...
print("  matches q @ k.transpose(-2,-1) within floating-point tolerance")
