...
A quick self-contained recap, so nothing below rests on remembering the [attention post](../fundamentals/architectures/01-attention-from-scratch.qmd).
